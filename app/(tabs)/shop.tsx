        ...
        {selectedTab === 'subscriptions' ? (
          <View style={styles.subscriptionsContainer}>
            ...
            {subscriptionPlans.map((plan) => (
              <TouchableOpacity key={plan.id} activeOpacity={0.9}>
                <Card style={[styles.planCard, plan.popular && styles.planCardPopular]}>
                  {plan.popular && (
          ...
          <View style={styles.devicesContainer}>
            ...
            {devices.map((device) => (
              <TouchableOpacity key={device.id} activeOpacity={0.9}>
